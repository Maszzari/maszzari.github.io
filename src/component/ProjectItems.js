	...
	return (
		<div className="w-full flex flex-wrap mt-7 gap-5">
			<div className="w-full md:w-[calc(100%/2-10px)] lg:w-[calc((100%/3)-(20px-(20px/3)))] text-center">
				...
				<a href="/" className="font-medium text-base lg:text-2xl text-sky-800 inline-block mt-3">Membuat Portofolio</a>
				<span className="text-xs lg:text-base text-slate-400 block">3 Agustus 2022</span>
			</div>
		</div>
	);
}
